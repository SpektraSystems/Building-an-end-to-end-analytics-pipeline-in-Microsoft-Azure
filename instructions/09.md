...
3. Note that you will need to **replace the ADLS G2 Storage account** in cell 4.Then Click on **Run All** or execute the cell one by one to understand each cell in a better way.
   
   ![datascience values](images/datasciencevalues.png)
